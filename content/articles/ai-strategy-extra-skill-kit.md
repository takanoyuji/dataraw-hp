...
- 型を仕込む考え方 → [「戦略的に考えて」は効かない。AIに効いた指示の書き方](/articles/ai-strategy-02-instructions)
- 型を入れても一発では出ないこと → [AIは「それっぽい論理」なら作れる。向きは間違えるが](/articles/ai-strategy-03-plausible-logic)
